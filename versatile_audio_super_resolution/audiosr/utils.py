...
from versatile_audio_super_resolution.audiosr.lowpass import lowpass
...
def get_basic_config():
    return {
        ...
        "model": {
            "target": "versatile_audio_super_resolution.audiosr.latent_diffusion.models.ddpm.LatentDiffusion",
            "params": {
                "first_stage_config": {
                ...
                "scale_by_std": True,
                "unet_config": {
                    "target": "versatile_audio_super_resolution.audiosr.latent_diffusion.modules.diffusionmodules.openaimodel.UNetModel",
                    "params": {
                        "image_size": 64,
                        "in_channels": 32,
                        "out_channels": 16,
                ...
                "cond_stage_config": {
                    "concat_lowpass_cond": {
                        ...
                        "target": "versatile_audio_super_resolution.audiosr.latent_diffusion.modules.encoders.modules.VAEFeatureExtract",
                        "params": {
                            "first_stage_config": {
                                "base_learning_rate": 0.000008,
                                "target": "versatile_audio_super_resolution.audiosr.latent_encoder.autoencoder.AutoencoderKL",
